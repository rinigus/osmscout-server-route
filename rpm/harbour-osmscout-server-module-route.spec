...
%define __requires_exclude ^libboost_|libicudata|libicui18n|libicuuc|libprime_server|libzmq|libczmq|libprotobuf|libz|liblz4.*$
# << macros
...
BuildRequires:  valhalla == 2.6.2
BuildRequires:  valhalla-devel == 2.6.2
